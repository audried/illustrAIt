export const generatePrompt = (tracks, artists) => {
    ...
    //use genre to get subject: country = landscape, pop= dreamscape, rap/hiphop = abstract, edm="dreamscape", else=random
    //count {country, folk, bluegrass, stomp and holler, roots}
    //count {pop, indie, alternative}
    //count {rap, hip hop, rock}
    //count {edm, dance, psychedelic, hyperpop, electronic}
