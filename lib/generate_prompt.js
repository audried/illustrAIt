...
export const generatePrompt = (tracks, artists) => {
    ...
    const formats = [", digital art", ", 3d render", ", 5mm film photograph", ", stained glass",  ", oil painting", ", hyperrealistic", ", ukioh-e"]
    ...
    const chosen_track = top5tracks[Math.floor((Math.random()*5))]
    const chosen_album = top5albums[Math.floor((Math.random()*5))]
    ...
    var caption = "inspired by " + chosen_track + " and " + chosen_album + " and " + top_genre + " music"
