...
export const generatePrompt = (tracks, artists) => {
    ...
    var chosen_track = fixTitle(top5tracks[randomtrack])
    top5tracks.splice(randomtrack,1)
    var second_track = fixTitle(top5tracks[Math.floor((Math.random()*4))])
    ...
    var query = chosen_track + ' ' + second_track + subject
    ...
    return ([query, caption, chosen_track, second_track, top_genre])
}
