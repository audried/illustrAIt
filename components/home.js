        ...
        <Container height={visible?'100%':'100vh'} maxWidth={'100%'} mx={0} px={0} className={styles.homepage}>
            ...
            <Stack
              ...
              <Text as={'span'} color={'white'}>
                ...
                We hope to make this site available to the public soon! In the meantime, you can view a demo <Link href = "https://drive.google.com/file/d/1_zcSk8e8HA8_sS2fw9I-qIdJGWWElKz3/view?usp=sharing"><u>here</u></Link> )
                </Text>
