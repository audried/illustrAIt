    ...
    <Container maxW={'100%'} className={styles.login}>
      <Stack
        ...
        <Text as={'span'} color={'gray.100'} maxW={'5xl'}>
          ...
          Check out the photos below to see real examples that were created based on users&#39; spotify profiles. You can view a demo <Link href = "https://drive.google.com/file/d/1azRLGX-SkSVj5O6uI-O7sjR9ZP0zTjAQ/view?usp=sharing"><u>here</u></Link>
        </Text>
